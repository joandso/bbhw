    ...
    if (window.hotelFeatures && window.hotelFeatures.length > 0) {
        ...
        map.on('load', function () {
            map.addSource('hotels', {
                ...
                cluster: true,
                clusterMaxZoom: 15, // Adjust as needed
            ...
            // Add a layer for the unclustered points (individual markers)
            map.addLayer({
                id: 'unclustered-point',
                type: 'symbol',
                source: 'hotels',
                filter: ['!', ['has', 'point_count']], // Only show points that are not part of a cluster
                layout: {
                    'icon-image': 'custom-marker', // Assuming you have added a custom marker image
                    'icon-size': 1,
                    'text-field': ['get', 'name'],
                    'text-offset': [0, 1.25],
                    'text-anchor': 'top'
            ...
            // Add popup to the unclustered points
